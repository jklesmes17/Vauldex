...
ALTER TABLE "ATTENDANCE" ADD CONSTRAINT "FK_ID_EMPLOYEE" FOREIGN KEY("ID_EMPLOYEE") REFERENCES "EMPLOYEE"("ID") ON UPDATE CASCADE ON DELETE CASCADE;

# --- !Downs
<<<<<<< Updated upstream
=======
ALTER SEQUENCE EMPLOYEE_ID_seq RESTART WITH 10000;
>>>>>>> Stashed changes
